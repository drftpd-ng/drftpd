set VMARGS=-server -Djava.library.path=lib -Djava.rmi.server.hostname=you_didnt_edit_master.bat -Djava.rmi.server.randomIDs=true -Djava.rmi.server.disableHttp=true
