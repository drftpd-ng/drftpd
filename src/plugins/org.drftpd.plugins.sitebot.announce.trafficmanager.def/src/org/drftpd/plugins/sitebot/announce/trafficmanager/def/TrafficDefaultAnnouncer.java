 ...
 */
package org.drftpd.master.plugins.sitebot.announce.trafficmanager.def;
...
/**
 * @author CyBeR
 * @version $Id: TrafficDefaultAnnouncer.java 2072 2010-09-18 22:01:23Z djb61 $
 */
public class TrafficDefaultAnnouncer extends AbstractAnnouncer {
    ...
    public void onTrafficTypeEvent(TrafficTypeEvent event) {
    	if (event.getType().equalsIgnoreCase("default")) {
            AnnounceWriter writer = _config.getSimpleWriter("trafficmanager.def");
            if (writer != null) {
