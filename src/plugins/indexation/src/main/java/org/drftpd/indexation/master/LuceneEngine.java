...
package org.drftpd.indexation.master;
...
import org.drftpd.indexation.master.analysis.AlphanumericalAnalyzer;
...
public class LuceneEngine implements IndexEngineInterface {
     ...
     */
    private void reload() {
        Properties cfg = ConfigLoader.loadPluginConfig("lucene.conf", ConfigType.MASTER);
