...
/**
 * @author mog
 * @version $Id: Transfer.java,v 1.24 2004/08/03 20:14:03 zubov Exp $
 */
public interface Transfer extends Remote {
    ...
    public TransferStatus receiveFile(String dirname, char mode,
        String filename, long offset) throws RemoteException, IOException;

    public TransferStatus sendFile(String path, char mode, long resumePosition)
