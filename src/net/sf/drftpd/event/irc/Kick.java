...
/**
 * @author Teflon
 * @version $Id: Kick.java,v 1.1 2004/07/16 02:53:46 teflon114 Exp $
 */
public class Kick extends GenericAutoService implements IRCPluginInterface {
	...
	protected void updateCommand(InCommand inCommand) {
		...
		try {
			ReplacerFormat kickirc =
				ReplacerUtils.finalFormat(Kick.class, "kick.irc");
			ReplacerFormat kickftp =
				ReplacerUtils.finalFormat(Kick.class, "kick.ftp");
