...
public class ListUtils {
	...
	public static List list(LinkedRemoteFile directoryFile, BaseFtpConnection conn) {
		return list(directoryFile, conn, null);
	}

	public static List list(LinkedRemoteFile directoryFile, BaseFtpConnection conn, FtpReply response) {
		...
		try {
			...
			if(response != null) response.addComment("zipscript error: " + e.getMessage());
