...
public class MLST implements CommandHandlerFactory, CommandHandler {
	...
	public String[] getFeatReplies() {
		return new String[] { "MLST type*,x.crc32*,size*,modify*,unix.owner*,unix.group*,x.slaves*,x.xfertime*" };
	}
