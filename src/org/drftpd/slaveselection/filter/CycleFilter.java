 ...
 * 
 * @author mog, zubov
 * @version $Id: CycleFilter.java,v 1.4 2004/03/21 08:06:38 zubov Exp $
 */
	...
	public void process(
		...
		while (true) {
			...
			for (Iterator iter = equalList.iterator(); iter.hasNext();) {
				ScoreChart.SlaveScore match =
					(ScoreChart.SlaveScore) iter.next();
				if (match.getRSlave().getLastTransferForDirection(direction)
