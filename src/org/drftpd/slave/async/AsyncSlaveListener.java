        ...
        while (true) {
            ...
            for (Iterator i = slaves.iterator(); i.hasNext();) {
                ...
                if (rslave.isAvailable()) {
                    logger.info("AsyncSlaveListener: online> " +
                        rslave.getName());
                ...
                if (saddr == null) {
                    logger.info("AsyncSlaveListener: noaddr> " +
                        rslave.getName());
                ...
                if (!saddr.equals("Dynamic")) {
                    logger.info("AsyncSlaveListener: static> " +
                        rslave.getName());
            ...
            if (match) {
                ...
                try {
                    AsyncSlave tmp = new AsyncSlave(_conman,
                ...
                try {
                    AsyncSlaveListener.invalidSlave("INITFAIL Unregistered",
                        slave);
                } catch (Exception e) {
                }
            }
