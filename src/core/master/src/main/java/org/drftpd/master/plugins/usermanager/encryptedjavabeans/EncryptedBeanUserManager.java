package org.drftpd.master.plugins.usermanager.encryptedjavabeans;
...
import org.drftpd.master.plugins.usermanager.javabeans.BeanUser;
import org.drftpd.master.plugins.usermanager.javabeans.BeanUserManager;
...
public class EncryptedBeanUserManager extends BeanUserManager {
  ...
  public void onReloadEvent(ReloadEvent event) {
	...
	private void readPasscrypt() {
		Properties cfg = ConfigLoader.loadPluginConfig("encryptedbeanuser.conf", ConfigType.MASTER);
