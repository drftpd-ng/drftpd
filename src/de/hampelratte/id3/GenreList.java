...
/** This class is a list of the standard genre list for id3v1 tags with the nullsoft extensions
 *
...
public class GenreList
{
    ...
    {
        if(getGenreIndex(genre) != -1) return true;
        else return false;
    }
